...
var _natec425$voltorb_flip$Game_Main$main = {
	main: _elm_lang$html$Html_App$program(
		{init: _natec425$voltorb_flip$Game_Core$init, view: _natec425$voltorb_flip$Game_View$view, update: _natec425$voltorb_flip$Game_Core$update, subscriptions: _natec425$voltorb_flip$Game_Core$subscriptions})
};

var Elm = {};
Elm['Game'] = Elm['Game'] || {};
Elm['Game']['Main'] = Elm['Game']['Main'] || {};
_elm_lang$core$Native_Platform.addPublicModule(Elm['Game']['Main'], 'Game.Main', typeof _natec425$voltorb_flip$Game_Main$main === 'undefined' ? null : _natec425$voltorb_flip$Game_Main$main);
